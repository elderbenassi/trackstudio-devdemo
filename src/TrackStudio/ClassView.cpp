...
/////////////////////////////////////////////////////////////////////////////
// Manipuladores de mensagens CClassView
...
int CClassView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	{
		TRACE0("Falha ao criar o Modo de Exibição de Classe\n");
		return -1;      // falha ao criar
	}

	// Carregar imagens:
	m_wndToolBar.Create(this, AFX_DEFAULT_TOOLBAR_STYLE, IDR_SORT);
	m_wndToolBar.LoadToolBar(IDR_SORT, 0, 0, TRUE /* Está bloqueado */);
	...
	// Preencha alguns dados do modo de exibição de árvore estáticos (código fictício, não há nenhuma mágica aqui)
	FillClassView();
...
{
	AfxMessageBox(_T("Adicionar função de membro..."));
}
...
void CClassView::OnChangeVisualStyle()
{
	...
	{
		TRACE(_T("Não é possível carregar o bitmap: %x\n"), uiBmpId);
		ASSERT(FALSE);
		return;
	}
